...
// Firstly lets define a class for nodes of the tree to be constructed 
class Node{
    public:
        int data;
        Node*left;
...
// Now we will define methods to add data and nodes to our tree
...
// Any function needs a display code so void is used to display the tree and data in it here
...
// For BST we till now define a method to find the minimum value
...
// Errors are always there so we define a deletion method to deal with such errors
