...
class Node{
    ...
    Node(string name,int age){
        this->name=name;
        this->age=age;
        next=NULL; //starting list by next as NULL
        prev=NULL; //starting list by prev as NULL
    }
};

//INSERTION OF DATA AT END OF LINKED LIST
...
//INSERTION OF DATA AT START OF LINKED LIST
...
//DISPLAY OF DATA AT START OF LINKED LIST
...
//DISPLAY OF DATA AT END OF LINKED LIST
...
//DELETION OF ANY INDEX(0,n-1) EXCLUDING LAST ELEMENT 
...
int main(){
    ...
    //Taking no of family men as input
